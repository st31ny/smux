...
void cnf::set_master_file(std::unique_ptr<file_def> fl)
{
    set_symmetric_file(_master_file, std::move(fl));
}

void cnf::set_master_file_in(std::unique_ptr<file_def> fl)
{
    set_in_file(_master_file, std::move(fl));
}

void cnf::set_master_file_out(std::unique_ptr<file_def> fl)
{
...
void cnf::set_channel_file(smux_channel ch, std::unique_ptr<file_def> fl)
{
    set_symmetric_file(_channels[ch], std::move(fl));
}

void cnf::set_channel_file_in(smux_channel ch, std::unique_ptr<file_def> fl)
{
    set_in_file(_channels[ch], std::move(fl));
}

void cnf::set_channel_file_out(smux_channel ch, std::unique_ptr<file_def> fl)
{
